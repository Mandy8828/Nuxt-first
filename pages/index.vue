<template>
  <div class="flex w-full flex-col items-center">
    <div
      class="item-center mt-8 flex w-full max-w-4xl flex-col px-6 md:items-start lg:px-0"
    >
    ...
    <div class="my-8 flex w-full max-w-4xl flex-col">
      ...
      <template v-else>
        ...
        <div
          v-else-if="!articlesResponse || articlesResponse.items.length === 0"
        >
        ...
        <div v-else class="md:border-l md:border-gray-100">
          <div class="flex flex-col space-y-4 md:pl-6">
            ...
            >
              ...
              >
                <h2
                  class="text-base font-semibold tracking-tight text-gray-700"
                >
                  <span class="">{{ article.title }}</span>
                </h2>
                <time
                  class="order-first mb-3 flex items-center text-sm text-gray-400 md:hidden"
                >
              ...
              <time
                class="order-first mb-3 mt-1 hidden items-center text-sm text-gray-400 md:flex"
              >
                {{ date2LocaleString(article.updated_at) }}
              </time>
            </article>
      ...
      >
        <div class="flex flex-1 justify-center sm:justify-end">
          ...
          <label class="mx-2 text-sm text-gray-600"
